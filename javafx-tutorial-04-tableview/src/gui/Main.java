...
public class Main extends Application {
    ...
    private Node getTablePane() {
        ...
        nameColumn.setCellFactory(TextFieldTableCell.forTableColumn()); //nastaveni tovarny na bunky, bunka je zalozena na textfieldu
        ...
        commissionedColumn.setCellFactory(TextFieldTableCell.forTableColumn(new MyLocalDateStringConverter(Ship.FORMATTER)));
        commissionedColumn.setOnEditCommit(this:: commitCommissionedDateAction); //tuto akci vyvola tabulka pokazde kdy dojde k uspesnemu commitu hodnoty
        ...
        retiredColumn.setCellFactory(TextFieldTableCell.forTableColumn(new MyLocalDateStringConverter(Ship.FORMATTER)));
