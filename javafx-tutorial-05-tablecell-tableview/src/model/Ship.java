...
public class Ship { //odpovida jedne radce tabulky (jedne lodi)
    ...
    private DoubleProperty displacement = new CheckedSimpleDoubleProperty(CheckedSimpleDoubleProperty.POSITIVE_DOUBLE_PREDICATE); //property, ktera zajisti kladne cislo
    ...
    public Ship(String name, double displacement, LocalDate commissioned, LocalDate retired, ShipType type){
        ...
        displacementProperty().addListener((observable, oldValue, newValue) -> System.out.println("Updating real displacement: " + oldValue + " -> " + newValue)); //posloucha zmeny vytlaku
    }
